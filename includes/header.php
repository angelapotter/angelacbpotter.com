    ...
    <div class="containerXL">      
      <div class="header">
        ...
        <!-- <div class="h1Container"> -->
          <a href="/portfolio" title="home"><h1>angela potter design</h1></a>
        <!-- </div>         -->
        <!-- <a href="//www.angelacbpotter.com" title="home"><h2>interaction design</h2></a> -->
      </div>
      <div class="leftNavContainer nav">
        <div class="leftNav">
          ...
          <a href="/resume.php" title="resume" class="mainTab resumeLink">Resume</a>
          <a href="/about.php" title="resume" class="mainTab aboutLink">About</a>
          <a href="/twitter-feed.php" title="resume" class="mainTab twitterFeedLink">Twitter feed</a>
          <!-- <h5>print</h5>
          <span>OLSET biz cards</span> -->
        </div>
      </div>
