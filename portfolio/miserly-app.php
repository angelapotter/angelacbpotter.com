...
<div class="item">
 <!--  <div class="portfolioNav">
    <div class="invisible prev"><a href="olset-biz-cards.php" title="previous project"></a></div>
    <h2>olset.com</h2>
  ...
  <!-- <a href="https://www.olset.com" title="OLSET: Get personalized hotel recommendations in seconds" target="_blank"> -->
    <img src="images/miserly-photoshop-mockup.png" alt="miserly app mockups" />
  <!-- </a> -->
  <div class="content whiteBG topMarg20">
    <h2>miserly app mockup</h2>
  ...
  <img class="topMarg20" src="images/miserly-app-wireframe.png" alt="miserly app wireframe" />
  <div class="clear"></div>
</div>
